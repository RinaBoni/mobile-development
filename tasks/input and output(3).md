...
версии Flutter Release Preview 2 и Dart SDK 2.1.0](https://flutter.su/note/1)

Есть модуль написанный на дарт [«validator» pub.dartlang.org/packages/validator](https://pub.dev/packages/validator), если его подключить, 
